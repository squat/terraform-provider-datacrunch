...
// SDK - DataCrunch Provider: Public API for datacrunch platform
type SDK struct {
	// user balance
	Balance *Balance
	Images  *Images
	// a datacrunch server instance
	Instances      *Instances
	InstanceTypes  *InstanceTypes
	Locations      *Locations
	Authentication *Authentication
	// startup scripts that execute when an instance is deployed
	StartupScripts *StartupScripts
	// ssh keys for your instances
	SSHKeys *SSHKeys
	Volumes *Volumes
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.0.1",
			GenVersion:        "2.188.1",
			UserAgent:         "speakeasy-sdk/go 0.0.1 2.188.1 1.0.0 datacrunch",
		},
	}
	...
	sdk.Instances = newInstances(sdk.sdkConfiguration)

	sdk.InstanceTypes = newInstanceTypes(sdk.sdkConfiguration)

	sdk.Locations = newLocations(sdk.sdkConfiguration)

	sdk.Authentication = newAuthentication(sdk.sdkConfiguration)

	sdk.StartupScripts = newStartupScripts(sdk.sdkConfiguration)
